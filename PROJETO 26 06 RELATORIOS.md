    ...
    # MODULO DE ESTOQUE
        ...
        input ("TECLE QUALQUER TECLA PARA CONTINUAR: ")
         ...
         while True:
            ...
            if pp == "1":
                print("Muito Bem Você escolheu o relatorio Geral!!")
                print()
                ...
                limpar_tela()
                print("Muito Bem Você escolheu A listagem Com Filtro")
                print()

                pet = str(input("Digite o Nome do seu Pet:  "))
                ...
                limpar_tela()
                print("Muito Bem Você escolheu o Filtro + O Processamento")
                print()
                ...
                print("Quantidade de clientes encontrados:", quantidade)
                ...
                for idd in clientes:
                    if idd in anim:
                        ...
                        print("ID:", idd)
                        print("Cliente:", clientes[idd][0])
                        print("Pet:", clientes[idd][2])
                        print("Data da Vacina:", anim[idd][1])
                        print("-------------------")
